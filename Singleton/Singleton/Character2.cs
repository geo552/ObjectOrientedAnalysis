...
namespace Singleton
{
    class Character2
    {
        private static Character2 uniqueInstance;
        private static int health;
        private string name;
        private static bool status;
        private static bool shield;
        private Character2() : this("Неизвестно") { }

        private Character2(string name) : this(name, health = 100) { }

        private Character2(string name, int health)
        {
            this.name = name;
